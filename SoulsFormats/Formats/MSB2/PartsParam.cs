...
#pragma warning restore CS1591 // Missing XML comment for publicly visible type or member
        ...
        public abstract class Part : NamedEntry
        {
            ...
            public class Navmesh : Part
            {
                ...
                /// Unknown; possibly nvm groups.
                /// </summary>
                public uint UnkT00 { get; set; }

                /// <summary>
                /// Unknown; possibly nvm groups.
                /// </summary>
                public uint UnkT04 { get; set; }

                /// <summary>
                /// Unknown; possibly nvm groups.
                /// </summary>
                public uint UnkT08 { get; set; }

                /// <summary>
                /// Unknown; possibly nvm groups.
                /// </summary>
                public uint UnkT0C { get; set; }
                ...
                internal override void ReadTypeData(BinaryReaderEx br)
                {
                    UnkT00 = br.ReadUInt32();
                    UnkT04 = br.ReadUInt32();
                    UnkT08 = br.ReadUInt32();
                    UnkT0C = br.ReadUInt32();
                    br.AssertPattern(0x10, 0x00);
                }

                internal override void WriteTypeData(BinaryWriterEx bw)
                {
                    bw.WriteUInt32(UnkT00);
                    bw.WriteUInt32(UnkT04);
                    bw.WriteUInt32(UnkT08);
                    bw.WriteUInt32(UnkT0C);
                    bw.WritePattern(0x10, 0x00);
                }
            }
